...
/***/ "./wp-content/themes/acesdelta/assets/js/dropdown.js":
/*!********************************************************!*\
  !*** ./wp-content/themes/acesdelta/assets/js/dropdown.js ***!
  \********************************************************/
...
(function ($j) {
  ...
  function hideItemFromList() {
    var selectedValueText = $j('.js-dropdown__selected a').text();
    $j('.js-section-overview__list-item').each(function (index, el) {
  ...
  function getSeletedValue() {
    var $selectedValue = $j('.js-dropdown__selected a');
    var $breadcrumbAnchor = $j('.js-breadcrumb__anchor');
    $j('.js-section-overview__list-item').on('click', function (evt) {
      ...
      var newValue = $j(evt.currentTarget).text();
      var newValueAnchor = $j(evt.currentTarget).attr('href').split('#')[1];
      $selectedValue.text(newValue).attr('href', "#".concat(newValueAnchor));
  ...
  function toggleAnchorList() {
    $j('.js-dropdown__selected').on('click', function (evt) {
      evt.preventDefault();
      var $anchor = $j(evt.currentTarget).closest('.js-dropdown__wrapper');
  ...
  function getTitleAnchor() {
    if ($j('.js-dropdown').length) {
      ...
      $j(window).on('resize scroll', function () {
        var headerHeight = $j('.js-header-nav').height();
        var topicSectionHeight = $j('.js-dropdown').outerHeight();
        var totalHeight = headerHeight + topicSectionHeight + 200;

        // Find the id of the title
        $j('.wp-block-mkl-section-block h3, .wp-block-mkl-section-block h2').each(function (index, el) {
...
/***/ "./wp-content/themes/acesdelta/assets/js/grid.js":
/*!****************************************************!*\
  !*** ./wp-content/themes/acesdelta/assets/js/grid.js ***!
  \****************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
(function ($j) {
  ...
  function filterGrid(grid) {
    $j('.js-filter-item').on('click', function (evt) {
      var filterVal = $j(evt.currentTarget).attr('filter');
      $j('.js-grid__item').each(function (index, el) {
  ...
  function initOrDestroyMasonry() {
    ...
    var $grid = $j('.js-grid-wrapper').masonry(masonryOptions);
    var isActive = true;
  ...
  function openVideoModal() {
    $j('.js-video__thumbnail').on('click', function (evt) {
      $j('body').addClass('fixed');
      $j(evt.currentTarget).closest('.videos').find('.js-video-modal').addClass('open');
      setTimeout(function () {
        var $iframe = $j(evt.currentTarget).closest('.videos').find('iframe');
  ...
  function closeVideoModal() {
    $j('.js-video-modal').on('click', function (evt) {
      ...
      setTimeout(function () {
        var $iframe = $j(evt.currentTarget).find('iframe');
...
/***/ "./wp-content/themes/acesdelta/assets/js/main.js":
/*!****************************************************!*\
  !*** ./wp-content/themes/acesdelta/assets/js/main.js ***!
  \****************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _dropdown_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dropdown.js */ "./wp-content/themes/acesdelta/assets/js/dropdown.js");
/* harmony import */ var _grid_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./grid.js */ "./wp-content/themes/acesdelta/assets/js/grid.js");
/* harmony import */ var _navigation_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./navigation.js */ "./wp-content/themes/acesdelta/assets/js/navigation.js");
/* harmony import */ var _scripts_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./scripts.js */ "./wp-content/themes/acesdelta/assets/js/scripts.js");
 // eslint-disable-line
...
/***/ "./wp-content/themes/acesdelta/assets/js/navigation.js":
/*!**********************************************************!*\
  !*** ./wp-content/themes/acesdelta/assets/js/navigation.js ***!
  \**********************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
(function ($j) {
  ...
  var $button = $j('.menu-toggle');
  var $menu = $j('.main-navigation .menu');
  var $windowWidth;
  function stickyMenu() {
  ...
  function addBackgroundToNav() {
    var $siteHeader = $j('.js-site-header');
  ...
  function stickyAnchorNav() {
    var $dropdown = $j('.js-dropdown');
    var $siteHeader = $j('.js-site-header');
    var $heading = $j('.js-heading');
    var $entryContent = $j('.entry-content');
    if ($dropdown.length) {
      $j(window).on('scroll touchmove', function () {
  ...
  $j(document).ready(function () {
    ...
    $j(window).bind('resize', function () {
      ...
      if ($windowWidth <= 767) {
        ...
        $menu.children('.menu-item-has-children').each(function (index, el) {
          $j(el).children('a').append('<span class="more"></span>').off().on('click', function (e) {
        ...
        $menu.find('.menu-item-has-children').each(function (index, el) {
...
/***/ "./wp-content/themes/acesdelta/assets/js/scripts.js":
/*!*******************************************************!*\
  !*** ./wp-content/themes/acesdelta/assets/js/scripts.js ***!
  \*******************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
(function ($j) {
  ...
  function brochureFormStep() {
    $j('.brochure-form .wp-block-button a').click(function () {
      var email = $j('.form-step-1 input').val();
      if (isEmail(email)) {
  ...
  function checkIfOnlyAInP() {
    $j('.basic-content-section').each(function (index, el) {
      $j(el).find('p').each(function (i, item) {
  ...
  function toggleSearchForm() {
    $j('.js-search__icon').on('click', function () {
      var $searchForm = $j('.js-search__form');
  ...
  function openResourceBlockVideoModal() {
    $j('.js-video-link, .category-videos img').on('click', function (e) {
      $j('body').addClass('fixed');
      $j(e.currentTarget).closest('li, .search__post').find('.js-video-modal').addClass('open');
      setTimeout(function () {
        var $iframe = $j(e.currentTarget).closest('li, .search__post').find('iframe');
        var src = $iframe.attr('src').replace(/&autoplay=\d/, '');
        src += '&autoplay=1';
        $iframe.attr('src', src);
      }, 100);
  ...
  function equalHeight(item) {
    var maxHeight = 0;
    return $j(item).each(function (index, el) {
      var boxHeight = $j(el).height();
      maxHeight = Math.max(maxHeight, boxHeight);
    }).height(maxHeight);
  }
  function matchTitleHeightSearchPage() {
    $j('.search__article-row').each(function (index, el) {
  ...
  function onSuccesSubmit() {
    $j(document).on('gform_confirmation_loaded', function () {
...
jQuery.Event = function( src, props ) {
	...
	// Allow instantiation without the 'acesdelta' keyword
...
/***/ "./wp-content/themes/acesdelta/assets/sass/style.scss":
/*!*********************************************************!*\
  !*** ./wp-content/themes/acesdelta/assets/sass/style.scss ***!
  \*********************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/******/ 		var installedChunks = {
/******/ 			"/wp-content/themes/acesdelta/build/main": 0,
/******/ 			"wp-content/themes/acesdelta/build/style": 0
/******/ 		};
/******/ 		
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkcf_acesdelta"] = self["webpackChunkcf_acesdelta"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["wp-content/themes/acesdelta/build/style"], function() { return __webpack_require__("./wp-content/themes/acesdelta/assets/js/main.js"); })
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["wp-content/themes/acesdelta/build/style"], function() { return __webpack_require__("./wp-content/themes/acesdelta/assets/sass/style.scss"); })
