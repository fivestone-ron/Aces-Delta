...
export default ( props ) => {
	...
	const { tagName, customBackgroundColor, customTextColor, resizeTopIsActive, resizeBottomIsActive, bgImage, bgOptions, enableSpacing, sectionType } = attributes
	...
	return (
		<Fragment>
			<InspectorControls>
				...
				<SelectControl
					...
					options={ [
						...
						{ label: 'Basic Content', value: 'basicContent' },
			...
			<Section
				tagName={tagName}
				className={ props.className, sectionType }
				style={ {
