...
/**
 * The admin license page template.
 *
...
<p class="description">
	...
	echo sprintf(
		...
		esc_html__('See the %1$s help page %2$s for additional usage information.', 'cf-speed-daemon'),
...
<form method="post" action="options.php">
	<table class="form-table" role="presentation">
		<?php
		settings_fields('cf_speed_daemon_license');
		do_settings_sections('cf-speed-daemon-license');
